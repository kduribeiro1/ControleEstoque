    ...
    public partial class Inicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TiposUnidades", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Nome = table.Column<string>(type: "TEXT", nullable: false),
                    IdTipoUnidade = table.Column<int>(type: "INTEGER", nullable: false),
                    TipoUnidadeId = table.Column<int>(type: "INTEGER", nullable: false),
                    PrecoUnidade = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Produtos_TiposUnidades_TipoUnidadeId",
                        column: x => x.TipoUnidadeId,
                        principalTable: "TiposUnidades",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValorTotal = table.Column<int>(type: "INTEGER", nullable: false),
                    DataEntradaSaida = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Produtos_TipoUnidadeId",
                table: "Produtos",
